...
set security ike proposal proposal1 authentication-algorithm sha256
set security ike proposal proposal1 encryption-algorithm aes-256
...
```go
set security ike policy policy1 mode main
set security ike policy policy1 proposals proposal1
set security ike policy policy1 pre-shared-key ascii-text AdO1fWNKzX!!FDSD+@Mo*DGN!2
```
